...
class WeatherApi {
  async getCurrentForecast(cityName: string, apiKey: string) {
    ...
    const weather: Weather = {
      ...
      weatherIconUrl: utils.getWeatherIconByDescription(weatherDescription, sizeIcon),
      windForce: windForce,
      windVerbalDesignation: utils.getWindVerbalDesignationByWindSpeed(windForce),
      windDirection: utils.getWindDirectionByDeg(windDeg),
